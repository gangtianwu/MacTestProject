...
import com.example.mactestproject.databinding.FragmentGardenBinding;
import com.google.gson.Gson;
import com.google.gson.reflect.TypeToken;

import java.util.List;

public class GardenFragment extends androidx.fragment.app.Fragment {

    private FragmentGardenBinding gardenBinding;
    private List<PlantBean> data;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        gardenBinding = FragmentGardenBinding.inflate(inflater, container, false);
        return gardenBinding.getRoot();
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Gson gson = new Gson();
        data = gson.fromJson(dataText, new TypeToken<List<PlantBean>>(){}.getType());
        gardenRecyclerAdapter.submitList(data);
        gardenBinding.recyclerView.setAdapter(gardenRecyclerAdapter);
    }
}
