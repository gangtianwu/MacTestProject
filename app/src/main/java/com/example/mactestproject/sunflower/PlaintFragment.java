...
import com.example.mactestproject.databinding.FragmentPlaintBinding;
...
public class PlaintFragment extends androidx.fragment.app.Fragment {

    private FragmentPlaintBinding plaintBinding;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        plaintBinding = FragmentPlaintBinding.inflate(inflater, container, false);
        return plaintBinding.getRoot();
    }

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        PlaintRecyclerAdapter gardenRecyclerAdapter = new PlaintRecyclerAdapter(new DiffUtil.ItemCallback<PlantBean>() {
            @Override
            ...
            @Override
            public boolean areContentsTheSame(@NonNull PlantBean oldItem, @NonNull PlantBean newItem) {
                return false;
            }
        });
        String dataText = "[\n" +
        ...
        Gson gson = new Gson();
        Type type = new TypeToken<List<PlantBean>>() {
        }.getType();
        List<PlantBean> data = gson.fromJson(dataText, type);
        gardenRecyclerAdapter.submitList(data);
        plaintBinding.ryList.setAdapter(gardenRecyclerAdapter);
